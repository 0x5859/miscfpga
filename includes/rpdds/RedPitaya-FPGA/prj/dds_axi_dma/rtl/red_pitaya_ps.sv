...
module red_pitaya_ps (
  ...
  // Personal signals
  output logic [31:0] dds_mm2s_tdata_o,
  output logic [3:0]  dds_mm2s_tkeep_o,
  output logic        dds_mm2s_tvalid_o,
  input  logic        dds_mm2s_tready_i,
  output logic        dds_mm2s_tlast_o,

  input logic dds_axis_clk_i,
  input logic dds_axis_aresetn_i
...
rp_axi4_if #(.DW (64), .AW (32), .IW (4), .LW (4)) hp0_saxi (.ACLK (axi0_sys.clk), .ARESETn (axi0_sys.rstn));
rp_axi4_if #(.DW (64), .AW (32), .IW (4), .LW (4)) hp1_saxi (.ACLK (axi1_sys.clk), .ARESETn (axi1_sys.rstn));
// rp_axi4_if #(.DW (64), .AW (32), .IW (4), .LW (4)) hp2_saxi (.ACLK (axi2_sys.clk), .ARESETn (axi2_sys.rstn));
rp_axi4_if #(.DW (64), .AW (32), .IW (4), .LW (4)) hp3_saxi (.ACLK (axi3_sys.clk), .ARESETn (axi3_sys.rstn));
...
rp_axi4_if #(.DW (32), .AW (32), .IW (12), .LW (4)) axi_gp (.ACLK (bus.clk), .ARESETn (bus.rstn));
...
*/
  // HP3
  .S_AXI_HP3_arready (hp3_saxi.ARREADY), // out
  .S_AXI_HP3_awready (hp3_saxi.AWREADY), // out
  .S_AXI_HP3_bvalid  (hp3_saxi.BVALID ), // out
  .S_AXI_HP3_rlast   (hp3_saxi.RLAST  ), // out
  .S_AXI_HP3_rvalid  (hp3_saxi.RVALID ), // out
  .S_AXI_HP3_wready  (hp3_saxi.WREADY ), // out
  .S_AXI_HP3_bresp   (hp3_saxi.BRESP  ), // out 2
  .S_AXI_HP3_rresp   (hp3_saxi.RRESP  ), // out 2
  .S_AXI_HP3_bid     (hp3_saxi.BID    ), // out 6
  .S_AXI_HP3_rid     (hp3_saxi.RID    ), // out 6
  .S_AXI_HP3_rdata   (hp3_saxi.RDATA  ), // out 64
  .S_AXI_HP3_aclk    (hp3_saxi.ACLK   ), // in
  .S_AXI_HP3_arvalid (hp3_saxi.ARVALID), // in
  .S_AXI_HP3_awvalid (hp3_saxi.AWVALID), // in
  .S_AXI_HP3_bready  (hp3_saxi.BREADY ), // in
  .S_AXI_HP3_rready  (hp3_saxi.RREADY ), // in
  .S_AXI_HP3_wlast   (hp3_saxi.WLAST  ), // in
  .S_AXI_HP3_wvalid  (hp3_saxi.WVALID ), // in
  .S_AXI_HP3_arburst (hp3_saxi.ARBURST), // in 2
  .S_AXI_HP3_arlock  (hp3_saxi.ARLOCK ), // in 2
  .S_AXI_HP3_arsize  (hp3_saxi.ARSIZE ), // in 3
  .S_AXI_HP3_awburst (hp3_saxi.AWBURST), // in 2
  .S_AXI_HP3_awlock  (hp3_saxi.AWLOCK ), // in 2
  .S_AXI_HP3_awsize  (hp3_saxi.AWSIZE ), // in 3
  .S_AXI_HP3_arprot  (hp3_saxi.ARPROT ), // in 3
  .S_AXI_HP3_awprot  (hp3_saxi.AWPROT ), // in 3
  .S_AXI_HP3_araddr  (hp3_saxi.ARADDR ), // in 32
  .S_AXI_HP3_awaddr  (hp3_saxi.AWADDR ), // in 32
  .S_AXI_HP3_arcache (hp3_saxi.ARCACHE), // in 4
  .S_AXI_HP3_arlen   (hp3_saxi.ARLEN  ), // in 4
  .S_AXI_HP3_arqos   (hp3_saxi.ARQOS  ), // in 4
  .S_AXI_HP3_awcache (hp3_saxi.AWCACHE), // in 4
  .S_AXI_HP3_awlen   (hp3_saxi.AWLEN  ), // in 4
  .S_AXI_HP3_awqos   (hp3_saxi.AWQOS  ), // in 4
  .S_AXI_HP3_arid    (hp3_saxi.ARID   ), // in 6
  .S_AXI_HP3_awid    (hp3_saxi.AWID   ), // in 6
  .S_AXI_HP3_wid     (hp3_saxi.WID    ), // in 6
  .S_AXI_HP3_wdata   (hp3_saxi.WDATA  ), // in 64
  .S_AXI_HP3_wstrb   (hp3_saxi.WSTRB  ), // in 8
  // Personal signals
  .dds_mm2s_tdata(dds_mm2s_tdata_o),
  .dds_mm2s_tkeep(dds_mm2s_tkeep_o),
  .dds_mm2s_tlast(dds_mm2s_tlast_o),
  .dds_mm2s_tready(dds_mm2s_tready_i),
  .dds_mm2s_tvalid(dds_mm2s_tvalid_o),
  .dds_axis_clk_i(dds_axis_clk_i),
  .dds_axis_aresetn_i(dds_axis_aresetn_i)
